...
export async function createHabit(_: BaseFormState, formData: FormData): Promise<BaseFormState> {
	const name = formData.get("name") as string;
	const color = formData.get("color") as string;
...
export async function updateHabit(_: BaseFormState, formData: FormData): Promise<BaseFormState> {
